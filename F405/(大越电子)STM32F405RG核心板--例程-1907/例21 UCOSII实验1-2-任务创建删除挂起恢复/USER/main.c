...
void start_task(void *pdata)
{
	...
	OSStatInit();					//初始化统计任务.这里会延时1秒钟左右	
 	...
 	OSTaskCreate(led0_task,(void *)0,(OS_STK*)&LED_TASK_STK[LED_STK_SIZE-1],LED_TASK_PRIO);						    				   
...
{	
	...
	while(1)
	{
		...
		{
		  OSTaskDelReq(LED1_TASK_PRIO);	//发送删除BEEP任务请求，任务睡眠，无法恢复
		}
		else if(key_Num==4)
		{
		 OSTaskCreate(led1_task,(void *)0,(OS_STK*)&LED1_TASK_STK[LED1_STK_SIZE-1],LED1_TASK_PRIO);//重新创建任务LED1				   				   
		}   
 		delay_ms(10);
	}
}

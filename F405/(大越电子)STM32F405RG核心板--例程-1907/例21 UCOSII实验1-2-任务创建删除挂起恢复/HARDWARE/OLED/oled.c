...
//函数名称: void OLED_ShowNum(u8 x,u8 y,u32 num,u8 len,u8 size)
//函数功能：
//显示2个数字
//x,y :起点坐标	 
//len :数字的位数
...
//函数名称: void OLED_ShowString(u8 x,u8 y,u8 *chr)
//函数功能：//显示一个字符号串	 
...
//函数功能：*功能描述：显示显示BMP图片128×64起始点坐标(x,y),x的范围0～127，y为页的范围0～7* 

...
{ 
  arm_cfft_radix4_instance_f32 scfft;
	...
	Lcd_Clear(GRAY0);//清屏
	Gui_DrawFont_GBK16(0,16,RED,GRAY0,"    DSP FFT       ");
  Gui_DrawFont_GBK16(0,32,BLUE,GRAY0,"  嵌入式开发网   ");	 
	Gui_DrawFont_GBK16(0,48,BLUE,GRAY0,"mcudev.taobao.com ");
	Gui_DrawFont_GBK16(0,64,BLUE,GRAY0,"KEY1:Run FFT");//显示提示信息 
	Gui_DrawFont_GBK16(0,80,BLUE,GRAY0,"FFT runtime:");//显示FFT执行时间
 	...
 	while(1)
	{
		...
		if(key==KEY1_PRES)
		{
			...
			Gui_DrawFont_GBK16(0,96,BLUE,GRAY0,"               ");	//显示运行时间		
			Gui_DrawFont_GBK16(0,96,BLUE,GRAY0,buf);	//显示运行时间		

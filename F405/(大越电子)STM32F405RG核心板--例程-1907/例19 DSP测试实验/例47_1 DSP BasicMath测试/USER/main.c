...
{ 
	...
	Lcd_Clear(GRAY0);//清屏
	Gui_DrawFont_GBK16(0,16,RED,GRAY0,"  DSP BasicMath   ");
  Gui_DrawFont_GBK16(0,32,BLUE,GRAY0,"  嵌入式开发网   ");	 
	...
	Gui_DrawFont_GBK16(0,80,BLUE,GRAY0,"No DSP: ");	//显示提示信息
	Gui_DrawFont_GBK16(0,96,BLUE,GRAY0,"Use DSP: ");	//显示提示信息	
	...
	while(1)
	{
		...
		if(res==0)
			Gui_DrawFont_GBK16(72,80,BLUE,GRAY0,buf);	//显示运行时间		
		else 
			Gui_DrawFont_GBK16(72,80,BLUE,GRAY0,"error！");	//显示当前运行情况	
		...
		if(res==0)
			Gui_DrawFont_GBK16(72,96,BLUE,GRAY0,buf);	//显示运行时间	
		else 
			Gui_DrawFont_GBK16(72,96,BLUE,GRAY0,"error！");	//显示错误	

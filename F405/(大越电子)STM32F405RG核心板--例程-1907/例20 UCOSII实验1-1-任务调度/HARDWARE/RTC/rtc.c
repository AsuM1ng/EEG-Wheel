...
//********************************************************************************
//函数名称: ErrorStatus RTC_Set_Time(u8 hour,u8 min,u8 sec,u8 ampm)
...
//********************************************************************************
//函数名称: ErrorStatus RTC_Set_Date(u8 year,u8 month,u8 date,u8 week)
...
//********************************************************************************
//函数名称: void RTC_Set_AlarmA(u8 week,u8 hour,u8 min,u8 sec)
...
//函数名称: void RTC_Set_WakeUp(u32 wksel,u16 cnt)
...
//函数名称: void RTC_Alarm_IRQHandler(void)
...
//函数名称: void RTC_WKUP_IRQHandler(void)
